...
public interface IBase64Service
{
    ...
    Base64DecodeResponse ConvertToBase64(Base64DecodeRequest request);
    Base64EncodeResponse ConvertFromBase64(Base64EncodeRequest request);
    Base64Response ConvertImageToBase64(ConvertBase64FileRequest request);
    Base64ByteResponse ConvertImageFromBase64(Base64DecodeRequest request);
}